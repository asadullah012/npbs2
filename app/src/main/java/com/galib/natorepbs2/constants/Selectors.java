...
public class Selectors {
    ...
    public static final String AT_A_GLANCE_MONTH = "#left > div.page.details > div > div > div.html_text.body > div > p:nth-child(2)";
    public static final String AT_A_GLANCE = "#left > div.page.details > div > div > div.html_text.body > div > table";
}
