...
object URLs {
   const val BASE = "http://pbs2.natore.gov.bd/bn/site"
   const val AT_A_GLANCE = "/page/7XSs-এক-নজরে"
   const val COMPLAIN_CENTRE = "/news/Kxzl-অভিযোগ-কেন্দ্রের-মোবাইল-নম্বর"
   const val ACHIEVEMENTS = "/page/7te7-আমাদের-অর্জন"
   const val OFFICER_LIST = "/view/officer_list"
